...
line_types_ls = ['header', 'meta', 'content']
line_labels_ls = ['experience', 'experience-company', 'experience-job', 'experience-duration', 'experience-role',
               'knowledge-skills', 'education', 'education-level', 'education-school', 'education-years', 'education-grade',
               'project', 'portfolio', 'papers-articles', 'volunteer',
                  'objectives-intro', 'name', 'phone', 'email', 'other-contact', 'address', 'others']
